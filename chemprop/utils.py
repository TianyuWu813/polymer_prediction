...
def mape(targets: List[float], preds: List[float]) -> float:
    """
    Computes the mean squared error.
...
def build_optimizer(model: nn.Module, args: Namespace) -> Optimizer:
    ...
    """
    #params = [{'params': model.parameters(), 'lr': args.final_lr, 'weight_decay': 0}]
    # params = [{'params': model.encoder.parameters(), 'lr': args.init_lr*10, 'weight_decay': 0},
    #           {'params': model.ffn.parameters(), 'lr': args.init_lr*10, 'weight_decay': 0},
    #           {'params': model.trans.parameters(), 'lr': args.init_lr, 'weight_decay': 0}
    #           ]
    params = [{'params': model.parameters(), 'lr': args.init_lr, 'weight_decay': 0}]

    # params = [{'params': model.encoder.parameters(), 'lr': args.init_lr*10, 'weight_decay': 0},
    #           {'params': model.seq_encoder.parameters(), 'lr': args.init_lr * 10, 'weight_decay': 0},
    #           {'params': model.ffn.parameters(), 'lr': args.init_lr* 10, 'weight_decay': 0},
    #           {'params': model.trans.parameters(), 'lr': args.init_lr, 'weight_decay': 0}
    #           ]
    return Adam(params)
...
def build_lr_scheduler(optimizer: Optimizer, args: Namespace, total_epochs: List[int] = None) -> _LRScheduler:
    ...
    # return NoamLR(
    #     optimizer=optimizer,
    #     warmup_epochs=[args.warmup_epochs,args.warmup_epochs,args.warmup_epochs,args.warmup_epochs],
    #     total_epochs=total_epochs or [args.epochs,args.epochs,args.epochs,args.epochs] * args.num_lrs,
    #     steps_per_epoch=args.train_data_size // args.batch_size,
    #     init_lr=[args.init_lr*10,args.init_lr*10,args.init_lr* 10,args.init_lr],
    #     max_lr=[args.max_lr*10,args.max_lr*10,args.max_lr* 10,args.max_lr],
    #     final_lr=[args.final_lr*10,args.final_lr*10,args.final_lr* 10,args.final_lr]
    # )
    # return NoamLR(
    #     optimizer=optimizer,
    #     warmup_epochs=[args.warmup_epochs,args.warmup_epochs,args.warmup_epochs],
    #     total_epochs=total_epochs or [args.epochs,args.epochs,args.epochs] * args.num_lrs,
    #     steps_per_epoch=args.train_data_size // args.batch_size,
    #     init_lr=[args.init_lr*10,args.init_lr*10,args.init_lr],
    #     max_lr=[args.max_lr*10,args.max_lr*10,args.max_lr],
    #     final_lr=[args.final_lr*10,args.final_lr*10,args.final_lr]
    # )
    )
