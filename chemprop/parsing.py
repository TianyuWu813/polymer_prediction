...
def add_train_args(parser: ArgumentParser):
    ...
    parser.add_argument('--data_path', type=str,
                        ...
                        default='./data/albiciansK1_multiclass.csv')
    ...
    parser.add_argument('--features_path_HC10', type=str, nargs='*',
                        help='Path to features to use in FNN (instead of features_generator)')
    parser.add_argument('--features_path_Sau', type=str, nargs='*',
                        help='Path to features to use in FNN (instead of features_generator)')
    parser.add_argument('--features_path_Ecoli', type=str, nargs='*',
                        help='Path to features to use in FNN (instead of features_generator)')
    ...
    parser.add_argument('--multiclass_num_classes', type=int, default=8,
    ...
    parser.add_argument('--metric', type=str, default='rmse', #none
                        choices=['auc', 'prc-auc', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy', 'mape'],
    ...
    parser.add_argument('--hidden_size', type=int, default=300 ,  #300
    ...
    parser.add_argument('--ffn_hidden_size', type=int, default=None,
                        help='Hidden dim for higher-capacity FFN (defaults to hidden_size)')    #可改
    parser.add_argument('--ffn_num_layers', type=int, default=3,    #defalt 2
    ...
    # SEQ Model arguments
    ''' Sequence Settings '''
    parser.add_argument('--seq_num_layers', type=int, default=3)
    parser.add_argument('--seq_input_dim', type=int, default=300)  # 64  128 300
    parser.add_argument('--seq_hidden_size', type=int, default=300)  # 64  300
    parser.add_argument('--seq_latent_size', type=int, default=300)  # 64  300
    parser.add_argument('--seq_output_size_graph', type=int, default=300)  # 64 300
    parser.add_argument('--seq_dropout', type=float, default=0.0)
    parser.add_argument('--seq_layer', type=int, default=3,
                        help='seq layers.')
    # Trans Model arguments
    #parser = parent_parser.add_argument_group("GraphFormer")
    parser.add_argument('--tr_n_layers', type=int, default=12)  #12
    parser.add_argument('--tr_head_size', type=int, default=8)  #32
    parser.add_argument('--tr_hidden_dim', type=int, default=300) #512
    parser.add_argument('--tr_ffn_dim', type=int, default=300)   #512
    parser.add_argument('--tr_intput_dropout_rate', type=float, default=0.0)
    parser.add_argument('--tr_dropout_rate', type=float, default=0.0)
    parser.add_argument('--tr_weight_decay', type=float, default=0.0)
    parser.add_argument('--tr_attention_dropout_rate', type=float, default=0.0)
...
def modify_train_args(args: Namespace):
    ...
    if not ((args.dataset_type == 'classification' and args.metric in ['auc', 'prc-auc', 'accuracy']) or
            (args.dataset_type == 'regression' and args.metric in ['rmse', 'mae', 'mse', 'r2','mape']) or
    ...
    args.minimize_score = args.metric in ['rmse', 'mae', 'mse', 'cross_entropy','mape']
