...
class GraphFormer(nn.Module):
    ...
    def forward(self, seq_output,graph_output):#,perturb=None):
        ...
        graph_attn_bias = graph_attn_bias.unsqueeze(1)#.repeat(n_graph,1,1)  # [n_graph, n_head, n_node+1, n_node+1]
        graph_attn_bias = graph_attn_bias.transpose(1, 2)
        graph_attn_bias = graph_attn_bias.unsqueeze(2)
...
class MultiHeadAttention(nn.Module): # Full attention
