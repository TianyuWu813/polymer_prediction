...
def get_data(path: str,
             skip_invalid_smiles: bool = False,   #if bigsmiles false
             args: Namespace = None,
             features_path: List[str] = None,    #好像没用
    ...
    with open(path) as f:
        ...
        for line in reader:
            ...
            if smiles in skip_smiles:  #may delete
                continue
